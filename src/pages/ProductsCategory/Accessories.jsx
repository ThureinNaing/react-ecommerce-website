...
export default function Accessories() {
	...
	let { data: accessories } = useFetch(
		`http://localhost:3000/accessories${search ? `?q=${search}` : ""}`
	);
	return (
		<div className="space-y-5 p-5">
			<h1 className="font-bold text-3xl text-center">Accessories</h1>
			{accessories && (
